...
% if isfile(['Data/Outputs/',OutputAtom]) && Override==1
%     delete(['Data/Outputs/',OutputAtom]);
% end
% if isfile(['Data/Outputs/',OutputBond]) && Override==1
%     delete(['Data/Outputs/',OutputBond]);
% end
if ((~isfile(OutputAtom) || ~isfile(OutputBond)) && ~isfile(RawDataFileName)) || Override==1
