...
%                             N_seg = length(unique(BondData(:,2)));
                        ...
                        ComputeOutputs(Corners,BondData,AtomData,...
                            Np,N_Kuhn,b,kbT,dt,samp,OverrideCompute);
                    end
...
%     AtomsTemp = AtomData(AtomData(:,1)==timestep,:);
    ...
    N_free = N_stickers/2-N_bound; % No free bonds
    ...
    if i==1
        ...
        ka = no_attachments/N_free0/Dt; % Normalize by number of free potential bonds
...
N_chains = Np*2;        %Np is the number of pairs 
